...
print(f"dog.jpg - Predicted class: {predicted_class}, Probabilities: {probabilities}")
...
print(f"cat.jpg - Predicted class: {predicted_class_2}, Probabilities: {probabilities_2}")
